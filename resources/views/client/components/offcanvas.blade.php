    ...
    <div class="forDesktop">
        <div class="offcanvas-body mt-3">
            <div class="dropdown mt-3">
                <ul>
                    <li><a  href="/" >Home</a></li>
                    <li><a class="to" data-to="profile">Profile</a></li>
                    <li><a class="to" data-to="sustainability">Sustainability</a></li>
                    <li><a class="to" data-to="plant">Plant Tour</a></li>
                    <li><a class="to" data-to="product">Products</a></li>
                    <li><a class="to" data-to="end">End Applications</a></li>
                    <li><a class="to" data-to="production">Production Facilities</a></li>
                    <li><a class="to" data-to="news" >News</a></li>
                    <li><a class="to" data-to="career">Career</a></li>
    ...
    <div class="forMobile">
        <div class="offcanvas-body mt-3">
            <div class="dropdown mt-3 OffMobile" data-device=1>
                <ul>
                    <li><a  href="/" >Home</a></li>
                    <li><a class="to" data-device="1" data-to="profile" >Profile</a></li>
                    <li><a class="to" data-device="1" data-to="sustainability" >Sustainability</a></li>
                    <li><a class="to" data-device="1" data-to="plant" >Plant Tour</a></li>
                    <li><a class="to" data-device="1" data-to="product" >Products</a></li>
                    <li><a class="to" data-device="1" data-to="end">End Applications</a></li>
                    <li><a class="to" data-device="1" data-to="production" >Production Facilities</a></li>
                    <li><a class="to" data-device="1" data-to="news"  >News</a></li>
                    <li><a class="to" data-device="1" data-to="career" >Career</a></li>
                    <li><a class="to" data-device="1" data-to="contactsM" >Contact Us</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="forMobile">
        <div class="d-flex justify-content-start search-container">
            <form action="{{ route('search') }}" method="GET">
                <input type="text" name="search" placeholder="Type to search" id="inputM">
...
<script>
    ...
    window.addEventListener("resize", function() {
      if(window.innerHeight == fullWindowHeight) {
        ...
        document.querySelector(".offcanvas.offcanvas-end").style.top = 0;
      } else if(window.innerHeight < fullWindowHeight*0.9) {
        keyboardIsProbablyOpen = true;
        document.querySelector(".offcanvas.offcanvas-end").style.top = -30;
      }
    });
</script>

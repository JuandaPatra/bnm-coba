               ...
               <div class="row d-flex align-items-stretch">
                  <div class="col-md-8">
                     ...
                     <div class="form-group">
                        ...
                        <input id="input_career_departement" type="text" placeholder="" class="form-control @error('departement') is-invalid @enderror" name="departement" value="{{ old('departement', $career->departement) }}"/>
                        @error('departement')
                           <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                           </span>
                     ...
                     <div class="form-group">
                        ...
                        <textarea id="inputX" name="description" class="form-control @error('description') is-invalid @enderror" rows="30">{{ old('description', $career->description) }}</textarea>
                     </div>
                     @error('description')
                           <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                    ...
                    <!-- Subject -->
                     <div class="form-group">
                        ...
                        <textarea id="input_career_subjectEmail" name="subject_email" class="form-control @error('subject_email') is-invalid @enderror" rows="3">{{ old('subject_email',$career->subject_email) }}</textarea>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <!-- catgeory -->
                     {{-- <div class="form-group">
                        <label for="input_career_descriptionx" class="font-weight-bold">
                           Category
                        </label>
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    <input data-date-format="yyyy-mm-dd" id="datepicker" type="text" class="form-control" name="dueDate" value="{{ old('due_date',$career->due_date) }}" >

                          ...
                          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    <input data-date-format="yyyy-mm-dd" id="datepicker" type="text" class="form-control" name="publishDate" value="{{ old('publish_date',$post->publish_date) }}" placeholder="Select Date ..">

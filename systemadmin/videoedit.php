...
$listtitle = $mainlib->getpagetitle("Add/Edit video",$mainlib->ocn);
...

{
	...
	$ors = $mainlib->dbquery("select * from video where video_id='".$id."'",$mainlib->ocn);
...
function saveData(){
	...
	if(validateForm()){
		...
		document.frm.action = 'videoact.php';
	...
	$.ajax({
		...
		success: function(msg){
			...
			if(msg != ''){
				...
				location.href = "videoedit.php?id=<?php echo $id; ?>";
					...
					<td class="menudottedline" align="right">
						...
						<tr valign="middle" align="center">
							...
							<td>
								...
								<a class="toolbar" href="videolist.php?pgret=1"><img src="images/cancel_f2.png" alt="Cancel" border="0"><br>Cancel</a>
...
<script type='text/javascript'>Calendar.setup({inputField : 'posting_date',	ifFormat : 'y-mm-dd',button : 'calender_date',align  : '',singleClick : true});</script>
                            ...
                            <tr class="row0">
									...
									<td width="22%">&nbsp;<b>ID Video</b></td>

									<td width="78%">

										<input type="text" name="uri" class="inputtext" maxlength="255" style="width:500px" value="<?php echo $uri; ?>">
                ...
                <tr class="row5">
                  ...
                  <?php
                                    ...
                                    $query = $mainlib->dbquery("select * from imagevideo where video_id='".$id."'",$mainlib->ocn);

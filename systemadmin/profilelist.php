...
$idcol = "profile_id";
$listtitle = $mainlib->getpagetitle("Profile",$mainlib->ocn);
$listeditpage = "profileedit.php";
$listactionpage = "profileact.php";

$arcolcaption = array("ID","Title","Start Date","End Date","Link");
$arcolname = array("profile_id","title","start_date","end_date","link");
$arcolwidth = array("2%","10%","10%","10%");

$initsortcol = "profile_id"; //When the list is first time opened, the sort order column will be $initsortcol
$initsortcolascending = false; //Determines whether $initsortcol sort direction is ascending (true) or descending (false)

$arfiltercolcaption = array("ID","Title","Start Date","End Date","Link");
$arfiltercolname = array("profile_id","title","start_date","end_date","link");

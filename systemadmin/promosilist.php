...
$idcol = "promosi_id";
$listtitle = $mainlib->getpagetitle("Promosi Marketing",$mainlib->ocn);
$listeditpage = "promosiedit.php";
$listactionpage = "promosiact.php";

$arcolcaption = array("ID","Posting Date","Title");
$arcolname = array("promosi_id","posting_date","title_id");
$arcolwidth = array("2%","10%","20%");

$initsortcol = "promosi_id"; //When the list is first time opened, the sort order column will be $initsortcol
...
$arfiltercolname = array("promosi_id","posting_date","title_id");

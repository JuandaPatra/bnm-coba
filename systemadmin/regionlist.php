...
$idcol = "region_id";
$listtitle = $mainlib->getpagetitle("Region",$mainlib->ocn);
$listeditpage = "regionedit.php";
$listactionpage = "regionact.php";

$arcolcaption = array("ID","Region");
$arcolname = array("region_id","region_name");
$arcolwidth = array("2%","20%");

$initsortcol = "region_id"; //When the list is first time opened, the sort order column will be $initsortcol
$initsortcolascending = false; //Determines whether $initsortcol sort direction is ascending (true) or descending (false)

$arfiltercolcaption = array("ID","Region");
$arfiltercolname = array("region_id","region_name");

...
$idcol = "gallery_id";
$listtitle = $mainlib->getpagetitle("Gallery",$mainlib->ocn);
$listeditpage = "galleryedit.php";
$listactionpage = "galleryact.php";

$arcolcaption = array("ID","Posting Date","Header");
$arcolname = array("gallery_id","posting_date","header");
$arcolwidth = array("2%","10%","20%");

$initsortcol = "gallery_id"; //When the list is first time opened, the sort order column will be $initsortcol
$initsortcolascending = false; //Determines whether $initsortcol sort direction is ascending (true) or descending (false)

$arfiltercolcaption = array("ID","Posting Date","Header");
$arfiltercolname = array("gallery_id","posting_date","header");

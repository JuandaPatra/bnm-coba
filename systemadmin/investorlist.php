...
$idcol = "investor_id";
$listtitle = $mainlib->getpagetitle("Hubungan Investor",$mainlib->ocn);
$listeditpage = "investoredit.php";
$listactionpage = "investoract.php";

$arcolcaption = array("ID","Posting Date","Title");
$arcolname = array("investor_id","posting_date","title_id");
$arcolwidth = array("2%","10%","20%");

$initsortcol = "investor_id"; //When the list is first time opened, the sort order column will be $initsortcol
...
$arfiltercolname = array("investor_id","posting_date","title_id");

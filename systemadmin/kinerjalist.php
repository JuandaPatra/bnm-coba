...
$idcol = "kinerja_id";
$listtitle = $mainlib->getpagetitle("Kinerja Keuangan",$mainlib->ocn);
$listeditpage = "kinerjaedit.php";
$listactionpage = "kinerjaact.php";

$arcolcaption = array("ID","Posting Date","Title");
$arcolname = array("kinerja_id","posting_date","title");
$arcolwidth = array("2%","10%","20%");

$initsortcol = "kinerja_id"; //When the list is first time opened, the sort order column will be $initsortcol
...
$arfiltercolname = array("kinerja_id","posting_date","title");

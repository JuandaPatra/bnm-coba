...
$listtitle = $mainlib->getpagetitle("FAQ",$mainlib->ocn);

$listeditpage = "faqedit.php";

$listactionpage = "faqact.php";



$arcolcaption = array("ID","Title");

$arcolname = array("faq_id","title");

$arcolwidth = array("2%","20%");



$initsortcol = "faq_id"; //When the list is first time opened, the sort order column will be $initsortcol
...
$arfiltercolname = array("faq_id","title");

...
$listtitle = $mainlib->getpagetitle("Press Release",$mainlib->ocn);

$listeditpage = "pressedit.php";

$listactionpage = "pressact.php";



$arcolcaption = array("ID","Date","Category","Title");

$arcolname = array("press_id","posting_date","category","title");

$arcolwidth = array("2%","10%","20%");



$initsortcol = "press_id"; //When the list is first time opened, the sort order column will be $initsortcol

$initsortcolascending = false; //Determines whether $initsortcol sort direction is ascending (true) or descending (false)



$arfiltercolcaption = array("ID","Posting Date","Category","Title");

$arfiltercolname = array("press_id","category","posting_date","title");

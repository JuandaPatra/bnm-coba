...
$idcol = "category_id";
$listtitle = $mainlib->getpagetitle("Category",$mainlib->ocn);
$listeditpage = "categoryedit.php";
$listactionpage = "categoryact.php";

$arcolcaption = array("ID","Category");
$arcolname = array("category_id","category_name_id");
$arcolwidth = array("2%","20%");

$initsortcol = "category_id"; //When the list is first time opened, the sort order column will be $initsortcol
$initsortcolascending = false; //Determines whether $initsortcol sort direction is ascending (true) or descending (false)

$arfiltercolcaption = array("ID","Category");
$arfiltercolname = array("category_id","category_name_id");

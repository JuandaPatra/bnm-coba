...
$listeditpage = "productedit.php";
$listactionpage = "productact.php";

$arcolcaption = array("ID","Product Name","Category","Sub Category");
$arcolname = array("product_id","name_id","category_name_id","subcategory_name_id");
$arcolwidth = array("2%","10%","10%","10%");

$initsortcol = "product_id"; //When the list is first time opened, the sort order column will be $initsortcol
...
$arfiltercolname = array("product_id","name_id","category_name_id","subcategory_name_id");

$sql = "select p.*, c.* from product p, category c  where p.category_id = c.category_id";
?>

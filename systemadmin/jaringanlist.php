...
$idcol = "jaringan_id";
$listtitle = $mainlib->getpagetitle("Jaringan",$mainlib->ocn);
$listeditpage = "jaringanedit.php";
$listactionpage = "jaringanact.php";

$arcolcaption = array("ID","Network","Branch");
$arcolname = array("jaringan_id","network","branch");
$arcolwidth = array("2%","10%","10%");

$initsortcol = "jaringan_id"; //When the list is first time opened, the sort order column will be $initsortcol
$initsortcolascending = false; //Determines whether $initsortcol sort direction is ascending (true) or descending (false)

$arfiltercolcaption = array("ID","Network","Branch");
$arfiltercolname = array("jaringan_id","network","branch");

$sql = "select * from jaringan";
?>

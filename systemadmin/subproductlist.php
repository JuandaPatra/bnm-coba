...
$idcol = "id";
$listtitle = $mainlib->getpagetitle("Product",$mainlib->ocn);
$listeditpage = "subproductedit.php";
$listactionpage = "subproductact.php";

$arcolcaption = array("ID","Product ID","Product Name","Category","Product");
$arcolname = array("id","pi","subproduct_name","category_name","product_name");
$arcolwidth = array("2%","10%","10%","10%");

$initsortcol = "id"; //When the list is first time opened, the sort order column will be $initsortcol
$initsortcolascending = false; //Determines whether $initsortcol sort direction is ascending (true) or descending (false)

$arfiltercolcaption = array("ID","Product Name","Category","Sub Category");
$arfiltercolname = array("id","subproduct_name","category_name","product_name");

$sql = "select sp.pages_id as id,sp.product_id as pi, sp.title_id as subproduct_name,
            c.category_name_id as category_name,p.name_id as product_name,
                p.name_id as product_name from pages sp 

...
$listtitle = $mainlib->getpagetitle("Add/Edit Press Release",$mainlib->ocn);
...

{
	...
	$ors = $mainlib->dbquery("select * from press where press_id='".$id."'",$mainlib->ocn);
...
function saveData(){
	...
	if(validateForm()){
		...
		document.frm.action = 'pressact.php';
	...
	$.ajax({
		...
		success: function(msg){
			...
			if(msg != ''){
				...
				location.href = "pressedit.php?id=<?php echo $id; ?>";
					...
					<td class="menudottedline" align="right">
						...
						<tr valign="middle" align="center">
							...
							<td>
								...
								<a class="toolbar" href="presslist.php?pgret=1"><img src="images/cancel_f2.png" alt="Cancel" border="0"><br>Cancel</a>
							...
							<td valign="top" align="center">
                                ...
                                <tr class="row0">
									...
									<select name="category">
                                        ...
                                        <option value="Corporate" <?php if($category == "Corporate"){ echo 'selected="selected"'; } ?>>Corporate</option>

                                        <option value="Non Corporate" <?php if($category == "Non Corporate"){ echo 'selected="selected"'; } ?>>Non Corporate</option>

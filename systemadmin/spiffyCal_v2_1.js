...
function ctlSpiffyCalendarBox(strVarName, strFormName, strTextBoxName, strBtnName, strDefaultValue, intBtnMode) {
	...
	this.minYearChoice=dteToday.getFullYear()-80;
	...
	function makeCalendar(intWhatMonth,intWhatYear,bViewOnly) {
		...
		if (scNN6) {
			strOutput += strTemp +'<table width="185" border="3" class="cal-Table" cellspacing="0" cellpadding="0"><tr><td align="center" style="line-height:10px;font-size:10px"><font face="arial" color="#ffffff">Use the arrows to select the correct Month/Year, then click on the desired date</font></td></tr><tr>';
		}
		else {
			strOutput += '<table width="185" border="3" class="cal-Table" cellspacing="0" cellpadding="0"><tr><td align="center" style="line-height:10px;font-size:10px"><font face="arial" color="#ffffff">Use the arrows to select the correct Month/Year, then click on the desired date</font></td></tr>'+strTemp+'<tr>';
		}
	...
	function writeControl() {
		...
		strHold='<input readonly class="cal-TextBox" type="text" name="' + this.textBoxName + '"' + strTemp + 'size="12" value="' + this.getSelectedDate() + '">';
		if (!scIE) {

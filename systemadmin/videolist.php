...
$listtitle = $mainlib->getpagetitle("Video",$mainlib->ocn);

$listeditpage = "videoedit.php";

$listactionpage = "videoact.php";



$arcolcaption = array("ID","Posting Date","Title");

$arcolname = array("video_id","posting_date","title");

$arcolwidth = array("2%","10%","20%");



$initsortcol = "video_id"; //When the list is first time opened, the sort order column will be $initsortcol
...
$arfiltercolname = array("video_id","posting_date","title");

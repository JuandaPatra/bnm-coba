...
$idcol = "slider_id";
$listtitle = $mainlib->getpagetitle("Slider",$mainlib->ocn);
$listeditpage = "slideredit.php";
$listactionpage = "slideract.php";

$arcolcaption = array("ID","Title","Start Date","End Date","Link");
$arcolname = array("slider_id","title","start_date","end_date","link");
$arcolwidth = array("2%","10%","10%","10%");

$initsortcol = "slider_id"; //When the list is first time opened, the sort order column will be $initsortcol
...
$arfiltercolname = array("slider_id","title","start_date","end_date","link");

...
$mainlib = new mainlib();
$mainlib->opendb();
$listtitle = $mainlib->getpagetitle("Add/Edit Region",$mainlib->ocn);
...
if(trim($id)!="")
{
	$ors = $mainlib->dbquery("select * from region where region_id='".$id."'",$mainlib->ocn);
	if($row = $mainlib->dbfetcharray($ors))
	{
		$region_name = htmlentities(stripslashes($row["region_name"]));
	}
...
function validateForm()
{
	with(document.frm){
		...
		if(isBlank(region,'Entry required in Region field!')) return false;
	}
	return true;
}
...
function saveData(){
	if(validateForm()){
		document.frm.action = 'regionact.php';
		document.frm.submit();
	}
}
</script>
				...
				<tr>
					<td class="menudottedline" align="right">
						...
						<tr valign="middle" align="center">
							...
							<td>
								<a class="toolbar" href="regionlist.php?pgret=1"><img src="images/cancel_f2.png" alt="Cancel" border="0"><br>Cancel</a>
							</td>
						</tr>
						</table>
					</td>
						...
						<tr>
							<td valign="top" align="center">
                                ...
                                <tr class="row0">
									...
									<td width="78%">
										<input type="text" name="region" class="inputtext" maxlength="255" style="width:500px" value="<?php echo $region; ?>">
									</td>
								</tr>
								</table>
							</td>

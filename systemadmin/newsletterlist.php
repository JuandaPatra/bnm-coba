...
$idcol = "newsletter_id";
$listtitle = $mainlib->getpagetitle("Investor Newsletter",$mainlib->ocn);
$listeditpage = "newsletteredit.php";
$listactionpage = "newsletteract.php";

$arcolcaption = array("ID","Posting Date","Title");
$arcolname = array("newsletter_id","posting_date","title");
$arcolwidth = array("2%","10%","20%");

$initsortcol = "newsletter_id"; //When the list is first time opened, the sort order column will be $initsortcol
$initsortcolascending = false; //Determines whether $initsortcol sort direction is ascending (true) or descending (false)

$arfiltercolcaption = array("ID","Posting Date","Title");
$arfiltercolname = array("press_id","posting_date","title");

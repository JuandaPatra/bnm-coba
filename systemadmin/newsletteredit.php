...
$mainlib = new mainlib();
$mainlib->opendb();
$listtitle = $mainlib->getpagetitle("Add/Edit Investor Newsletter",$mainlib->ocn);
...
if(trim($id)!="")
{
	$ors = $mainlib->dbquery("select * from newsletter where newsletter_id='".$id."'",$mainlib->ocn);
...
function saveData(){
	if(validateForm()){
		document.frm.action = 'newsletteract.php';
		document.frm.submit();
	}
}
...
function DelFile()
{
	$.ajax({
		...
		success: function(msg){
			if(msg != ''){
				$('#'+msg).remove();
				location.href = "newsletteredit.php?id=<?php echo $id; ?>";
			}
		}
	});
}
				...
				<tr>
					<td class="menudottedline" align="right">
						...
						<tr valign="middle" align="center">
							...
							<td>
								<a class="toolbar" href="newsletterlist.php?pgret=1"><img src="images/cancel_f2.png" alt="Cancel" border="0"><br>Cancel</a>
							</td>
						</tr>
						</table>
					</td>

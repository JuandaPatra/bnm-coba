...
$idcol = "award_id";
$listtitle = $mainlib->getpagetitle("Awards",$mainlib->ocn);
$listeditpage = "awardedit.php";
$listactionpage = "awardact.php";

$arcolcaption = array("ID","Judul");
$arcolname = array("award_id","judul");
$arcolwidth = array("2%","10%");

$initsortcol = "award_id"; //When the list is first time opened, the sort order column will be $initsortcol
$initsortcolascending = false; //Determines whether $initsortcol sort direction is ascending (true) or descending (false)

$arfiltercolcaption = array("ID","Judul");
$arfiltercolname = array("award_id","judul");

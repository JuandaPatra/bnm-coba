...
$idcol = "layanan_id";
$listtitle = $mainlib->getpagetitle("Layanan Dan Produk",$mainlib->ocn);
$listeditpage = "layananedit.php";
$listactionpage = "layananact.php";

$arcolcaption = array("ID","Posting Date","Title");
$arcolname = array("layanan_id","posting_date","title_id");
$arcolwidth = array("2%","10%","20%");

$initsortcol = "layanan_id"; //When the list is first time opened, the sort order column will be $initsortcol
...
$arfiltercolname = array("layanan_id","posting_date","title_id");

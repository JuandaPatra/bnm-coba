...
$idcol = "news_id";
$listtitle = $mainlib->getpagetitle("News",$mainlib->ocn);
$listeditpage = "newsedit.php";
$listactionpage = "newsact.php";

$arcolcaption = array("ID","Posting Date","Title");
$arcolname = array("news_id","posting_date","title_id");
$arcolwidth = array("2%","10%","20%");

$initsortcol = "news_id"; //When the list is first time opened, the sort order column will be $initsortcol
...
$arfiltercolname = array("news_id","posting_date","title_id");

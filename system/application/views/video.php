...
<title>BNM PRECISION STAINLESS STEEL: Video</title>
...
<div id="bgheader">
    ...
    <div id="judul"><img src="<?php echo base_url(); ?>images/hd-video.png" /></div>
</div>
<?php include'include/menu.php' ?>

<div id="content">
	<div style="width:560px; margin:30px auto;">
    	<iframe width="560" height="350" src="//www.youtube.com/embed/SLtsg_E7kpI" frameborder="0" allowfullscreen></iframe>
    </div>
</div>

...
class Cart extends Controller {
	...
	function confirm()
	{
		...
		$shipping_cost = isset($courier['price'])?$courier['price']:0;
...
foreach($cekCart->result_array() as $row ){
    $weight += $row['weight'];
            ...
            $text .="<tr>
            	<td></td><td bgcolor=\"#b9babe\" colspan=\"3\" 
                align=\"right\">Sub Total</td><td bgcolor=\"#b9babe\" align=\"right\">"."Rp. " . number_format($total,0)."</td></tr>";
            
            $text .="<tr>
            	<td></td><td bgcolor=\"#b9babe\" colspan=\"3\" 
                align=\"right\">Berat Total</td><td bgcolor=\"#b9babe\" align=\"right\">"." " . $weight."</td></tr>";
            
             $text .="<tr>
            	<td></td><td bgcolor=\"#ebecee\" colspan=\"3\" align=\"right\">Discounts ".$discount." %</td><td bgcolor=\"#ebecee\" align=\"right\"> "."Rp. " . number_format(($discount*$total/100),0)." </td>
            </tr>";
            /*
            <tr>
            ...
            $text .= "<tr>
            	<td></td><td bgcolor=\"#ebecee\" colspan=\"3\" align=\"right\">Shipping</td><td bgcolor=\"#ebecee\" align=\"right\">Rp. ".  number_format($shipping_cost,0)."</td</tr>"; 
            $text .="<tr>
            	<td></td><td bgcolor=\"#4b91c6\" colspan=\"3\" align=\"right\"><b>Total Amount</b></td><td bgcolor=\"#4b91c6\" align=\"right\"><b>"."Rp. " . number_format($total_cost,0)."</b></td>
            </tr>
        </table>
    </td></tr>
    ...
    <tr><td>
    	<table cellpadding=\"5\" width=\"100%\">
        	<tr>
            	<td bgcolor=\"#b9babe\"><b>Delivery address</b></td><td bgcolor=\"#b9babe\"><b>Courier</b></td>
            </tr>
            <tr>
            	<td bgcolor=\"#ebecee\">".$address."</td>";

	...
	{	
		...
		if ( $this -> _check_capthca($captcha) ) 
		{
			...
			if($insert)
			{
				...
				//require '/system/plugins/Exception.php';
				//require '/system/plugins/PHPMailer.php';
				//require '/system/plugins/SMTP.php';
				$mail = new phpmailer();
				//$mail->SetLanguage("en", 'system/language/');
				# Principal settings
				 ...
				 $mail->Password = "&**(!#$%)^MsT*^&()_+"; // SMTP pas
							...
							$mail->addAddress('suhariyanto.kusuma@bnmstainless.co.id','Yanto');

...
class SliderController extends Controller
{
    ...
    public function select(Request $request)
    {
        ...
        //     $search = $request->q;
        //     // return $search;
        //     $categories = Category::select('id', 'title')->where('title', 'LIKE', "%$request->keyword%")->limit(6)->get();
        // } else {
        ...
        if ($request->keyword) {
            ...
            $sliders = Slider::select('id', 'title')->where('title', 'LIKE', "%$search%")->limit(6)->get();
        } else {
            $sliders = Slider::select('id', 'title')->onlyParent()->get();
